...
func send_enemy_unit()-> void:
	...
	var random_supply_position: Vector3 = get_random_target_position()
	...
	if new_enemy_unit:
		...
		new_enemy_unit.set_movement_target(random_supply_position)
...
func get_random_target_position() -> Vector3:
	...
	if supply_targets[random_index] == null:
		...
		return supply_targets[random_index].global_position
